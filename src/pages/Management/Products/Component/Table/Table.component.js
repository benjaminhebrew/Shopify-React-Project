				...
				<TableBody>
					{props.rows.map((row) => (
						<StyledTableRow key={row.id}>
							...
							<StyledTableCell className={classes.row} align="right"><img className={classes.image} src={`${BASE_URL}${row.image}`} alt='the product' /></StyledTableCell>
							<StyledTableCell className={classes.row} align="right">{row.name}</StyledTableCell>
							<StyledTableCell className={classes.row} align="right">{row.group}</StyledTableCell>
